    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                {
                    Intent intent = new Intent(ActivitiesLesson_5_v2.this, ActivitiesLesson_1_v2.class);
                    startActivity(intent);
                }
                else if(id== R.id.item_Sevices)
                {
                    Intent intent = new Intent(ActivitiesLesson_5_v2.this, ActivitiesLesson_2_v2.class);
                    startActivity(intent);
                }
                else if(id== R.id.item_Broadcast_Recievers)
                {
                    Intent intent = new Intent(ActivitiesLesson_5_v2.this, ActivitiesLesson_3_v2.class);
                    startActivity(intent);
                }
                else if(id== R.id.item_Content_Providers)
                {
                    Intent intent = new Intent(ActivitiesLesson_5_v2.this, ActivitiesLesson_4_v2.class);
                    startActivity(intent);
                }
