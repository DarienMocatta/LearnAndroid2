...
public class ActivitiesLesson_4_v2 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activities_lesson_4_v2);
        ...
        //String Source from Android - Content Providers @developer.android.com/guide/topics/providers/content-providers
        //String stored in strings.xml - formatted via html and converted to string with following code.
        scrollTextView.setText(Html.fromHtml(getString(R.string.Lesson4_String)));
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                {
                    Intent intent = new Intent(ActivitiesLesson_4_v2.this, ActivitiesLesson_1_v2.class);
                    startActivity(intent);
                }
                else if(id== R.id.item_Sevices)
                {
                    Intent intent = new Intent(ActivitiesLesson_4_v2.this, ActivitiesLesson_2_v2.class);
                    startActivity(intent);
                }
                else if(id== R.id.item_Broadcast_Recievers)
                {
                    Intent intent = new Intent(ActivitiesLesson_4_v2.this, ActivitiesLesson_3_v2.class);
                    startActivity(intent);
                }
                else if(id== R.id.item_Content_Providers)
                {
                    Intent intent = new Intent(ActivitiesLesson_4_v2.this, ActivitiesLesson_4_v2.class);
                    startActivity(intent);
                }
                else if(id== R.id.item_Activity_Lifecycle)
                {
                    Intent intent = new Intent(ActivitiesLesson_4_v2.this, ActivitiesLesson_5_v2.class);
                    startActivity(intent);
                }
    ...
    // “Lecture 24: Android Persistent Storage and Content Providers (parts 1 and 2)” – Douglas Schmidt
    @Override
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        if (!b) {

           youTubePlayer.loadVideo("IWP2-qkhtiM");
